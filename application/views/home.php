...
<head>
	...
	<link href="https://fonts.googleapis.com/css?family=Poppins:100,300,500" rel="stylesheet">
		...
		CSS
		============================================= -->
		<link rel="stylesheet" href="<?= base_url('template/'); ?>css/linearicons.css">
	...
	<div class="oz-body-wrap">
			...
			<div class="container-fluid">
				<div class="header-wrap">
					<div class="header-top d-flex justify-content-between align-items-center">
						<div class="logo">
							<a href="<?= base_url('welcome'); ?>"><img src="<?= base_url('template/'); ?>img/logo.png" alt=""></a>
						</div>
						<div class="main-menubar d-flex align-items-center">
							<!-- <nav class="hide"> -->
								<a href="<?= base_url('auth'); ?>" class="genric-btn primary circle arrow">Login</a>
							<!-- </nav> -->
			...
			<div class="container">
				<div class="row fullscreen align-items-center justify-content-center">
					<div class="banner-left col-lg-6">
                        <br><br><br><br><br><br>
						<img class="d-flex mx-auto img-fluid" src="<?= base_url('template/'); ?>img/g10.png" height="700px" width="200px" alt="">
                        <br><br><br><br><br><br>
					</div>
					<div class="col-lg-6">
						<div class="story-content">
							<h6 class="text-uppercase">Join Cupo Cups and be part of the solution.</h6>
							<h2>Decrease <span class="sp-1">Disposable Cups</span><br>
							Save Landfill for <span class="sp-2"> Our Future</span></h2>
                            <br>
							<a href="<?= base_url('downloads/app-debug.apk'); ?>" class="genric-btn primary circle arrow">Download the app<span class="lnr lnr-arrow-right"></span></a>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="container">
				<div class="video-content">
					...
					<div class="video-desc">
						<h3 class="h2 text-white text-uppercase">FREE for cafes and drinkers</h3>
						<h4 class="text-white">Scan, swap, drink, return. Cupo Cup's is a FREE reusable café cup system for eco-focused cafes and drinkers lovers across Malang. Cafes love it, drinkers dig it and the planet high fives you for it.</h4>
					</div>
				</div>
			</div>
		</section>
		...
		<section class="about-area pt-100 pb-100">
			<div class="container">
				<div class="row align-items-center">
					<div class="col-lg-6">
						<div class="story-content">
							<h2>Why <span>Cupo?</span></h2>
							<p class="mt-30">Our eco-friendly cup solution gives you limited access to re-usable green cups for your coffee, tea, or other hot drinks. Simply signup and purchase your drink at a participating cafe, consume your drink, then return the used cup when you’re finished. 
                                You can return your used cup to the same cafe or any other participating cafe. Then grab a fresh cup the next time you order.
							</p>
							<a href="<?= base_url('auth/registration'); ?>" class="genric-btn primary-border circle arrow">Cafés sign up here <span class="lnr lnr-arrow-right"></span></a>
						</div>
					</div>
					<div class="col-lg-6">
						<img class="img-fluid d-flex mx-auto" src="<?= base_url('template/'); ?>img/G9.png" alt="">
					</div>
				</div>
			</div>
		</section>
		...
		<script src="<?= base_url('template/'); ?>js/vendor/jquery-2.2.4.min.js"></script>
		<script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.11.0/umd/popper.min.js" integrity="sha384-b/U6ypiBEHpOf/4+1nzFpr53nxSS+GLCkfwBdFNTxtclqqenISfwAzpKaMNFNmj4" crossorigin="anonymous"></script>
		<script src="<?= base_url('template/'); ?>js/vendor/bootstrap.min.js"></script>
