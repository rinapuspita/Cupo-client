...
<div class="container-fluid">
  ...
  <!-- Page Heading -->
  <h1 class="h3 mb-4 text-gray-800">Edit Data Pengembalian</h1>     
  <div class="row">
    <div class="col-lg-8">
      <?= form_open('pengembalian/editMitra/'.$kembali['id_kembali']);?>
      <div class="form-group row">
            <label for="id" class="col-sm-2 col-form-label">ID kembali</label>
            <div class="col-sm-10">
      ...
      <div class="form-group row">
            <label for="status" class="col-sm-2 col-form-label">Catatan</label>
            <div class="col-sm-10">
